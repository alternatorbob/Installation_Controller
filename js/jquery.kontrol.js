...
(function ($) {
  ...
  k.Dial = function () {
    ...
    this.xy2val = function (x, y, m) {
      ...
      if (m === "mouse" && this.o.flatMouse) {
        ...
        ret =
          ~~(0.5 + (a * (this.o.max - this.o.min)) / this.angleArc) +
          this.o.min;
      }
  ...
  k.XY = function () {
    ...
    this._coord = function () {
      for (var i in this.v) {
        this.m[i] = ~~(
          0.5 +
          (this.s[i] * this.v[i] - this.o.min) / this.f[i] +
          this.cur2
        );
        this.p[i] = this.m[i];
      }
  ...
  k.Bars = function () {
    ...
    this.extend = function () {
      ...
      this.colWidth =
        ((this.o.width - this.o.spacing * this.o.cols) / this.o.cols) >> 0;
    ...
    this._bar = function (col) {
      ...
      if (this.o.displayPrevious) {
        ...
        this.g.lineWidth = this.colWidth;
        this.g.strokeStyle =
          this.cv[col] == this.v[col] ? this.o.fgColor : this.pColor;
        if (this.o.cursor) {
          this.g.lineTo(
            x,
            this.mid - ((this.v[col] * this.bar) >> 0) + this.o.cursor / 2
          );
        } else {
          this.g.moveTo(x, this.mid);
        }
      ...
      if (this.o.cursor) {
        this.g.lineTo(
          x,
          this.mid - ((this.cv[col] * this.bar) >> 0) + this.o.cursor / 2
        );
      } else {
        this.g.moveTo(x, this.mid);
      }
